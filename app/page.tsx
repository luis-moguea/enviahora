        ...
        {showContent === "main" && (
          <Box minWidth="100%" overflow="hidden">
            ...
            <Box w="100%" mt={isHigherThan480 ? "unset" : "40px"}>
              ...
              >
                Ellos ya vivieron la experiencia. ¡Se tú el siguiente en
                vivirla!
              </motion.h2>
          ...
          >
            ...
            <Box mt="40px">
              ...
              <Box display="flex" mt={4} ml={4}>
                ...
                <Text textAlign="justify">
                  Para países seleccionados, nuestros envíos pueden entregarse
              ...
              <Box display="flex" mt={2} ml={4}>
                <Icon color="#ff6200" as={FaPlane} mr={2} />
                <Text textAlign="justify">
                  Para un alcance aún más amplio, extendemos nuestros servicios
                  a más de 215 países y territorios. En estos casos, los envíos
